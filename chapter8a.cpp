...
vec3 color(const ray& r, hitable *world, int depth) {
    ...
    // adjusted to 0.001 to ignore hits very near zero to avoid shadow acne problem
...
int main() {
    ...
    /*
    // weird
    list[0] = new sphere(vec3(0, 0, -1), 0.5, new metal(vec3(0.8, 0.8, 0.8)));
    list[1] = new sphere(vec3(0, -100.5, -1), 100, new metal(vec3(0.8, 0.6, 0.2)));
    list[2] = new sphere(vec3(1,0,-1), 0.5, new lambertian(vec3(0.8, 0.8, 0.0)));
